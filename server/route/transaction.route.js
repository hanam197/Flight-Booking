...
router.post("/create_payment_url", async (req, res) => {
  ...
  var returnUrl = "http://localhost:3000/paymentsucces";
...
// router.get("/vnpay_response", function (req, res, next) {
//   console.log("ok babi");
//   let vnp_Params = req.query;
...
router.get("/vnpay_response", function (req, res, next) {
  ...
  // Lưu toàn bộ thông tin từ phản hồi vào một biến
  let transactionData = {
    idTransactionVNPay: vnp_Params["vnp_TxnRef"],
    amount: vnp_Params["vnp_Amount"],
    bankCode: vnp_Params["vnp_BankCode"],
    thoiGianThanhToan: vnp_Params["vnp_PayDate"],
    transactionStatus: status,
    // ...
  };

  // Tạo một bản ghi mới trong CSDL MongoDB
  Transaction.create(transactionData, (err, newTransaction) => {
    if (err) {
